...
> The dataset includes information about individual teachers and courses. There are 22 columns of information and 8015 rows. 
...
> It appears that one row in the dataset measures answers for a single question for a particular course.
...
> The teacher id is 56347 and course id is PAB3SE004PA. The missing values are in the variable percent_failed_cur.
...
> We can see that the majority of professors have at least a masters degree, with most of them having a PhD. Additionally, we can see that many of the professors are new. We have a mean seniority of 5.33 for female and 5.67 for male professors. The difference between male and female professors is almost negligible, 48% are female and 52$ are male.
...
> There were 48 teacher-course combinations that asked all nine questions.
...
> The instructors with the lowest average SET score for question 1 are 100132 and 54201. There are a lot of instructors with a high average rating for question 1 across all of their course (many average scores of 5).
...
> The instructor with one year of experience and the highest fail rate is teacher_id 104362, and the instructor with one year of experience and the lowest fail rate is teacher_id 84689.
...
> The female instructor that has either a doctorate or professional degree with the highest average percent of students responding to evaluations is teacher_id 101508. The one with the lowest is teacher_id 3485.
